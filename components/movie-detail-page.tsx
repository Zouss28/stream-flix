...
import { Star, Play, Clock, Languages } from "lucide-react"
import Image from "next/image"
import { fetchMovieDetails, getStreamingUrl } from "@/lib/api"
...
export function MovieDetailPage({ id }: MovieDetailPageProps) {
  ...
  const handleLanguageChange = (language: "en" | "fr") => {
    ...
    router.replace(`/movie/${id}?${params.toString()}`, { scroll: false })
  }
  ...
  return (
    <div className="p-6">
      {isPlaying ? (
        <VideoPlayer
          src={getStreamingUrl(id, "movie", undefined, undefined, selectedLanguage)}
          title={movie.title}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Button onClick={handlePlay} size="lg" className="w-full sm:w-auto">
              ...
              Play Now ({selectedLanguage === "en" ? "English" : "Français"})
            </Button>
